...
BOT_TOKEN = os.environ.get('BOT_TOKEN', '6751025808:AAFby-IaU7KpVpTwwLkK_0DT3VXDqbO7E0M')
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", f"{script.CUSTOM_FILE_CAPTION}"<b><i>{filename}</i></b>|1080p:#1080p|720p:#720p|480p:#480p|[OTT]|2160p:#2160p|360p:#360p|540p:#540p|4K:#4K|10bit:#10bit|HEVC:#HEVC|Tamil:#Tamil|Malayalam:#Malayalam|Telugu:#Telugu|Hindi:#Hindi|Kannada:#Kannada|English:#English)
